...
---
# Antigua + Barbuda Fish Data
*required files: follows.csv*
...
## Bite rates (bites/sec) overall and while grazing
```{r, warning=FALSE, message= FALSE}
...
## Export csvs for integration with follow data
```{r,message=FALSE,warning=FALSE}
write.csv(site.follows,file="site.follows.csv")
