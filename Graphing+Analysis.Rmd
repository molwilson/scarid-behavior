...
### All predictors
```{r}
predictors <- site.sum %>% select(cover_LC,cover_TA,canopy_MA,canopy_TA,rugosity,scar.BM,scar.DEN,tot.BM) # should it matter if I use site level summary data vs. full follow dataset (where site-level data has been joined?)
