...
My research aims to document variations in grazing behavior across different reef conditions, testing for the effects of parrotfish abundance, predator abundance, and benthic condition on the amount of time parrotfish spend feeding, their bite rates, and the duration of their feeding bouts. Bonaire represents a relatively pristine Caribbean system, while Antigua has shifted to a more algal-dominated, low scarid state. I also conducted surveys in Barbuda, where a recent efforts to reduce parrotfish fishing may have interesting implications on grazing behavior. 

# Field season summary

In August of 2017, I set out to document parrotfish feeding behaviors in Antigua and Barbuda, two neighboring islands with historical overfishing and relatively degraded reefs systems. While parrotfish fishing continues in Antigua, a parrotfish fishing ban has recently been instated in Barbuda. Both of these islands would serve as comparisons to the pristine system in Bonaire that are more represenative of reef status in the larger Caribbean region.
