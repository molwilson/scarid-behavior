...
ggplot(filter(sum_ssp_grazed, species_code != "rbp" & phase == "i"), aes(x=factor(site, levels = sum_site$site), y=vg_mean)) +
...
ggplot(filter(sum_ssp_grazed, species_code != "rbp" & phase == "i"), aes(x=factor(site, levels = sum_site$site), y=vg_capped_mean)) +
    geom_bar(stat = "identity", aes(fill = island), position = "dodge") +
