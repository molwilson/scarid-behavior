...
fr(Antigua, *S. viride*, initial) = 445-8*L
fr(Antigua, *S. vetula*, initial) = 1030-12*L
fr(Bonaire, *S. viride*, initial) = 1057-17*L
fr(Bonaire, *S. vetula*, initial) = 1347+10*L
...
fr(Published, *S. viride*, initial) = 1089-17*L-56 
...
ggplot(filter(ag_melt, island == "Antigua"),
      aes(x=reorder(site, -area_grazed), y=area_grazed)) +
        ...
        labs(title=expression(Predicted~grazing~impact~on~Antiguan~reefs~(m^2/hr))) +
        theme_bw() +
