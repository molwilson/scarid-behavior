...
Predicting feeding intensity (site-level medians, island as random effect)
```{r, echo=F, message=F, warning=F}
m_data <- sum_ssp_pca
...
gtab_fi_site <- as.data.frame(rbind(g1,g2,g3,g4,g5,g6,g7,g8,g9,g10,g11,g12)) %>% setNames(c("g","Model", "AICc", "Adj. R2")) %>% arrange(AICc)
