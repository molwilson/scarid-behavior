...
ref_qup15 <- (3329-33*15)/60 # published feeding rate (bites/min)
...
grid.arrange(
  arrangeGrob(fr_qup, fr_stop, gfrac_qup, gfrac_stop, fi_qup, fi_stop, ncol=2, heights = c(1,1,1.5)), 
              arrangeGrob(legend), 
              ncol=2, widths = c(5,1))
