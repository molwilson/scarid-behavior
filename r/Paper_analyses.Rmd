...
fr_qup <- 
  ...
  #ylim(0, 50) +
  labs(y = expression(atop("Feeding rate", paste ("(bites ",min^-1,")"))), 
       title = "S. vetula") +
  theme_bw() + 
...
br_qup <- 
  ...
  geom_errorbar(aes(ymin=br_mean-br_se, ymax=br_mean+br_se), width=.2,
                 position=position_dodge(.9)) +
  scale_fill_manual(values = colors) +
  labs(y = expression(atop("Bite rate", paste ("(bites ",sec^-1,")"))), 
       x = "", 
       title = "") +
  theme_bw() + 
...
fi_qup <- 
  ...
  geom_errorbar(aes(ymin=for_bites_mean-for_bites_se, ymax=for_bites_mean+for_bites_se), width=.2,
                 position=position_dodge(.9)) +
  scale_fill_manual(values = colors) +
  labs(y = expression(atop("Grazing intensity", paste ("(bites ",foray^-1,")"))), 
       x = "", 
       title = "") +
  theme_bw() + 
...
m_data <- sum_ssp_pca
remove(g1, g2, g4, g6, g7, g8, g9, g10, g11, g12)
