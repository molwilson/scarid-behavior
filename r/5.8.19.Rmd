...
gtab_fr <- as.data.frame(rbind(g1,g2,g3,g4,g5,g6,g7,g8,g9,g10,g11)) %>% setNames(c("g","Model", "AIC", "Adj. R2")) %>% arrange(AIC)
```
...
gamm1 <- gamm(fr_mean ~ species_code + s(length_m, k=3) + s(pc1_all, k=3) + s(pc2_all, k=3), 
           family = gaussian(link=identity),
           random = list(island=~1),
           data = m_data
           )
...
gamm2 <- gamm(fr_mean ~ species_code + s(length_m, k=3) + s(pc1_all, k=3), 
           family = gaussian(link=identity),
           random = list(island=~1),
           data = m_data
           )
...
gamm3 <- gamm(fr_mean ~ species_code + s(length_m, by = factor(species_code), k=3) + s(pc1_all, by = factor(species_code), k=3) + s(pc2_all, by = factor(species_code), k=3),
           family = gaussian(link=identity),
           random = list(island=~1),
           data = m_data
           )
...
gamm4 <- gamm(fr_mean ~ species_code + s(length_m, by = factor(species_code), k=3) + s(pc1_all, by = factor(species_code), k=3) + s(pc2_all, k=3), 
           family = gaussian(link=identity),
           random = list(island=~1),
           data = m_data
           )
...
gamm5 <- gamm(fr_mean ~ species + s(length_m, by = factor(species_code), k=3) + s(pc1_all, by = factor(species_code), k=3), 
           family = gaussian(link=identity),
           random = list(island=~1),
           data = m_data
           )
...
gamm6 <- gamm(fr_mean ~ s(length_m, k=3) + s(pc1_all, by = factor(species_code), k=3), 
           family = gaussian(link=identity),
           random = list(island=~1),
           data = m_data
           )
...
gamm7 <- gamm(fr_mean ~ s(length_m, by = factor(species_code), k=3) + s(pc1_all, k=3), 
           family = gaussian(link=identity),
           random = list(island=~1),
           data = m_data
           )
...
gamm8 <- gamm(fr_mean ~ species + s(length_m, by = factor(species_code), k=3) + s(pc1_all, k=3), 
           family = gaussian(link=identity),
           random = list(island=~1),
           data = m_data
           )
...
gamm9 <- gamm(fr_mean ~ species + s(length_m, k=3) + s(pc1_all, by = factor(species_code), k=3), 
           family = gaussian(link=identity),
           random = list(island=~1),
           data = m_data
           )
...
gamm11 <- gamm(fr_mean ~ s(length_m, by = factor(species_code), k=3) + s(pc1_all, by = factor(species_code), k=3), 
           family = gaussian(link=identity),
           random = list(island=~1),
           data = m_data
           )
