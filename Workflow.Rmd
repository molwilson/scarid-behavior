...
3. Exploration/analysis files:
  ...
  - **Analysis.rmd**: initial boxplots/bargraphs looking at trends among islands/sites, testing ANOVAs/assumptions, predicted grazing impact, bite content calculations
  - **Models.rmd**: PCAs, LMEs, GAMMs (exploratory, no .csv exports)
  - **Ch2_outline_V3**: selected analyses for current manuscript outline